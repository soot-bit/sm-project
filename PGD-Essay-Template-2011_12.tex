%-----------------------------------------------------------------------------
% Template for AIMS PGD essay phase 2011-12
%
...
\title{The Essay Title is Usually a Succinct Description of Your Topic}
...
\date{{\small 17 May 2012}\\%
  {\scriptsize\it Submitted in partial fulfillment of 
    a postgraduate diploma at AIMS}\\%
  \vspace{3cm}{\includegraphics{images/AIMS_Logo_square-300.jpg}}}
%-------------------------------------------------------------------------
\begin{document}
\pagestyle{empty}
\maketitle
...
\bibliography{PGD-Essay-Template-2011_12}
